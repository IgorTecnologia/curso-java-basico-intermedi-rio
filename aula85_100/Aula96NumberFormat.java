...
public class Aula96NumberFormat {
	...
	public static void main(String[] args) throws ParseException {
		...
		porcent.setMaximumIntegerDigits(7); // máximo de números inteiros
		porcent.setMinimumIntegerDigits(5);
		
		porcent.setMaximumFractionDigits(2); // máximo de casas decímais
		...
		nf.setRoundingMode(RoundingMode.HALF_DOWN); // arredonda para baixo
