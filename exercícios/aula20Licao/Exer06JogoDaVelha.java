...
public class Exer06JogoDaVelha {
	...
	public static void main(String[] args) {
		...
		while(!ganhou) {
			...
			if (jogada % 2 == 1) { // jogador 1
				...
				System.out.println("Vez do jogador 2. Escolha linha e coluna (1, 2 ou 3).");
				sinal = 'O';
			}
			...
			while(!linhaValida) {
				...
				if ( linha >=1 && linha <=3) {
					...
					System.out.println("Linha inválida, Digite Novamente. Linha (1-3).");
				}
			}
